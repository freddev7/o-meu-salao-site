        ...
        <div>
            ...
            <div className='productlayout'>
                <div className='text_blockproducts'>
                    <h1>Linha <strong>Dream Gloss</strong></h1>
            ...
            <div className='productlayout_second'>
                ...
                <div className='text_blockproducts_second'>
                    <h1>Linha <strong>Pós-Química</strong></h1>
            ...
            <div className='productlayout_third'>
                <div className='text_blockproducts_third'>
                    <h1>Linha <strong>Blond</strong></h1>
            ...
            <div className='productlayout_fifth'>
                ...
                <div className='text_blockproducts_fifth'>
                    <h1>Linha <strong>INVISIBLE</strong></h1>
            ...
            <div className='productlayout_third'>
                <div className='text_blockproducts_third'>
                    <h1><strong>OX Descolorante</strong></h1>
            ...
            <div className='productlayout_fifth'>
                ...
                <div className='text_blockproducts_fifth'>
                    ...
                    <p>O Shampoo Antirresíduo Prime Process da My Dream abre parcialmente as cutículas, preparando os fios para receberem os tratamentos. Rico em Extrato de Baobá, Extrato de Caviar e Proteína do Trigo, juntos repõem nutrientes essenciais para a restruturação dos fios.</p>
                    <div className='button_product_third'>
            ...
            <div className='productlayout_fourth'>
                ...
                <div className='text_blockproducts_fourth'>
                    <h1>Linha <strong>Shampoo for men</strong></h1>
            ...
            <div className='productlayout_eight'>
                <div className='text_blockproducts_eight'>
                    <h1><strong>Pomada Modeladora</strong></h1>
