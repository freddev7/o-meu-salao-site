        ...
        <div>
            ...
            <div className='prodcourse_container'>
                <div className='block_prod'>
                    ...
                    <video src={videocourse} alt='videocourse' autoPlay muted loop controls={false} />
                </div>
            </div>
            <div className='prodcourse_containertwo'>
                ...
                <div className='video_block'>
                    <video src={videocoursemodel} alt='videocoursemodel' autoPlay muted loop controls={false}/>
                    ...
                    <video src={videocoursemodel2} alt='videocoursemodel2' autoPlay muted loop controls={false} />
                </div>
            </div>
