        ...
        <div className='home'>
            <div className='first_container'>
                <div className="first_text_block">
                    <h1 data-aos="fade-right">BEM VINDO(A)! <br />AO<br /> O MEU SALÃO</h1>
                    <div className='paragraph_text_block'>
                        <p data-aos="fade-left">Somos um dos melhores salões de Belo Horizonte, <strong>referência em alongamento adesivado invisível e prótese capilar,</strong> oferecendo os mais avançados e inovadores procedimentos e tecnologias para nossos clientes.</p>
                        <p data-aos="fade-left">Dispomos de um amplo espaço e uma equipe de profissionais altamente capacitados, prontos para atender às suas necessidades e proporcionar uma experiência inesquecível.</p>
                        <h2 data-aos="fade-right">VENHA VIVENCIAR ESSA EXPERIÊNCIA!</h2>
                    </div>
                </div>
            ...
            <div className='second_container'>
                <div className='second_container_img'>
                    <img src={photoprocd} alt='photoprocd' data-aos="fade-right" />
                </div>
                <div className='second_home_block'>
                    <div className='second_text_block'>
                        <h1 data-aos="fade-right">Por <span class="word">Camila Rodrigues</span>,<br /> criadora do método<span class="word"> Invisible!</span></h1>
                        <p data-aos="fade-right">Alongamento adesivado, totalmente indolor e imperceptível.<strong> Único método testado e aprovado por dermatologistas e tricologistas.</strong> Método exclusivo, desenvolvido pela expert em saúde capilar<strong> Camila Rodrigues</strong> que a mais de 20 anos vem transformando vidas atráves dos cabelos.</p>
                    </div>
                    <div className='home_first_btn'>
                        <Link to='/Courses'>
            ...
            <div className='third_container'>
                <div className='title_third_container'>
                    ...
                    <div className='title_container'>
                        <h1 data-aos="fade-right">Tenha o cabelo dos sonhos com o Invisible!</h1>
                    </div>
                </div>
            ...
            <div className='fifth_container'>
                <div className='title_fifth_container'>
                    <h1 data-aos="fade-down">Confira nossa linha de cosméticos exclusiva para você!</h1>
                    <img src={mdlogo} alt='mdlogo' data-aos="fade-up" />
                </div>
                <div className='fifth_block'>
                    <div className='fifth_text_block' data-aos="fade-right">
                    ...
                    <div className='fifth_text_block'>
                        <p data-aos="fade-down">Experimente os nossos produtos profissionais e sinta a diferença com cabelos sempre mais bonitos e saudáveis.</p>
            ...
            <div className='home_signature_container'>
                <div className='signature_content_container'>
                    <h1 data-aos="fade-right">Conheça os nossos planos e benefícios para o seu bem-estar.</h1>
                </div>
                <div className='acessibility_container'>
            ...
            <div className='sixth_container'>
                <div className='sixth_text'>
                    <h1 data-aos="fade-left">Surpreenda-se com a variedade e qualidade de nossos serviços!</h1>
                </div>
            </div>
